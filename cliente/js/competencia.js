...
function CompetenciasController () {
	...
	this.cargarCompetencias = function (data){
		...
		//var data = {"data":[{"id":1,"nombre":"¿Cuál es la mejor película?"},{"id":2,"nombre":"¿Qué drama te hizo llorar más?"},{"id":3,"nombre":"¿Cuál es la peli más bizarra?"},{"id":4,"nombre":"¿Cuál es la que te hizo reir más?"}]};
		//Oculto la plantilla
